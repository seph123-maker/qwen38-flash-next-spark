...
| Context limit says 262,144 instead of 679,000 | A long-context override was omitted or the runtime interprets it differently | Compare the full environment and RoPE arguments in `production.json`. The published launcher includes both. |
